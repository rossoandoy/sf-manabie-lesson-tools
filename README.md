...
| ドキュメント | 内容 |
|--------------|------|
| [利用開始ガイド](docs/user/getting-started-ja.md) | ZIP インストール → 初回セットアップ → 日常業務の入口 |
| [配布ガイド](docs/user/distribution-guide-ja.md) | IT / 導入担当者向け配布・バージョンアップ |
| [操作マニュアル](docs/user/operator-manual-ja.md) | 全機能の詳細操作 |

**配布物:** [GitHub Release v0.3.0](https://github.com/rossoandoy/sf-manabie-lesson-tools/releases/tag/v0.3.0) の `manabie-lesson-tools-v0.3.0.zip`
...
| **利用開始（業務）** | [user/getting-started-ja.md](docs/user/getting-started-ja.md) |
| **配布（IT）** | [user/distribution-guide-ja.md](docs/user/distribution-guide-ja.md) |
